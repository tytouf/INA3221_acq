...
//
void SDL_Arduino_INA3221::INA3221SetConfig(int ch)
{
  uint16_t ch_config = INA3221_CONFIG_ENABLE_CHAN1;
 
  switch(ch) {
    case 1:
      ch_config = INA3221_CONFIG_ENABLE_CHAN1;
      break;
    case 2:
      ch_config = INA3221_CONFIG_ENABLE_CHAN2;
      break;
    case 3:
      ch_config = INA3221_CONFIG_ENABLE_CHAN3;
      break;
    default:
      break;
 }
  // Set Config register to take into account the settings above
  uint16_t config = ch_config |
                    //INA3221_CONFIG_AVG1 |
...
*/
/**************************************************************************/
void SDL_Arduino_INA3221::begin(int ch) {
  Wire.begin();    
